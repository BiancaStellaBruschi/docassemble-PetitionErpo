...
setup(name='docassemble.PetitionErpo',
      version='1.0',
      description=('Petition for Extreme Risk Protection Order (ERPO)'),
      long_description='# docassemble.PetitionErpo\r\n\r\nPetition for Extreme Risk Protection Order (ERPO)\r\n\r\n## Author\r\n\r\nBianca Stella Bruschi\r\n\r\n',
      ...
      zip_safe=False,
      package_data=find_package_data(where='docassemble/PetitionErpo/', package='docassemble.PetitionErpo'),
     )
